...
/**
 * 'create hub sequence' DDL statement builder.
 * @author Alexey Chalov
 */
@Component
public class CreateHubSequenceDdlBuilder extends DdlBuilder {

    @Override
    public List<Pair<String, String>> build(EntityMeta entityMeta) {
        DSLContext ctx = newDslContext();
        String sequenceName = dsqlNamesService.getNames(entityMeta).getHubSequenceName();
