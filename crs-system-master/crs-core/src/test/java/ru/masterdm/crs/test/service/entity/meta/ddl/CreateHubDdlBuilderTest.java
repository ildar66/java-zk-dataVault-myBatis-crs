...
/**
 * Test for {@link CreateHubDdlBuilder}.
...
public class CreateHubDdlBuilderTest {

    private static final Logger LOG = LoggerFactory.getLogger(CreateHubDdlBuilderTest.class);
    ...
    public void testBuild() {
        List<Pair<String, String>> scripts = createHubDdlBuilder.build(entityMeta);
    ...
    public static void setup() throws Exception {
        ...
        entityMeta = objectMapper.readValue(CreateHubDdlBuilderTest.class.getResourceAsStream("dv_api_test_entity_meta.json"),
                                            EntityMeta.class);
    }
}
