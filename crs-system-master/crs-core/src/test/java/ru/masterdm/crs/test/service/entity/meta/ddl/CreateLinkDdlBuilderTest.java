...
/**
 * Test for {@link CreateLinkDdlBuilder}.
...
public class CreateLinkDdlBuilderTest {

    private static final Logger LOG = LoggerFactory.getLogger(CreateLinkDdlBuilderTest.class);
    ...
    public void testBuild() {
        List<Pair<String, String>> scripts = createLinkDdlBuilder.build(entityMeta);
    ...
    public static void setup() throws Exception {
        ...
        entityMeta = objectMapper.readValue(CreateLinkDdlBuilderTest.class.getResourceAsStream("dv_api_test_entity_meta.json"),
                                            EntityMeta.class);
    }
}
