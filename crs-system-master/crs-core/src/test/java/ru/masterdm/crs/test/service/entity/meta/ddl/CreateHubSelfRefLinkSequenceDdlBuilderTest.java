...
/**
 * Test for {@link CreateHubSelfRefLinkSequenceDdlBuilder}.
...
public class CreateHubSelfRefLinkSequenceDdlBuilderTest {

    private static final Logger LOG = LoggerFactory.getLogger(CreateHubSelfRefLinkSequenceDdlBuilderTest.class);
    ...
    public void testBuild() {
        Pair<String, String> scripts = createHubSelfRefLinkSequenceDdlBuilder.build(entityMeta).get(0);
    ...
    public static void setup() throws Exception {
        ...
        entityMeta = objectMapper.readValue(CreateHubSelfRefLinkSequenceDdlBuilderTest.class
                                                    .getResourceAsStream("dv_api_test_entity_meta.json"),
                                            EntityMeta.class);
    }
}
